...
class StaticUITests(unittest.TestCase):
    def test_javascript_dom_ids_exist(self):
        html = (ROOT / "ironman_harness" / "static" / "index.html").read_text(encoding="utf-8")
        javascript = (ROOT / "ironman_harness" / "static" / "app.js").read_text(encoding="utf-8")
    ...
    def test_static_assets_exist(self):
        static = ROOT / "ironman_harness" / "static"
